          ...
          <div className="bg-card rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto p-6 shadow-xl">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <input type="number" value={form.price} onChange={(e) => update("price", parseFloat(e.target.value) || 0)} placeholder="Price *" className="w-full px-3 py-2 rounded-lg border border-border bg-background text-foreground text-sm outline-none focus:ring-2 focus:ring-gold" />
